...
CHARACTER(LEN=2), DIMENSION(na) :: atom
    ...
    WRITE(*,FMT='(A33,A12)')   '                    ', "ATOMIC UNITS"
    WRITE(*,FMT='(A33,F12.8)') 'N-N Coulomb Energy: ', Enn
    WRITE(*,FMT='(A33,F12.8)') 'Electronic Energy:  ', E_ele
    WRITE(*,FMT='(A33,F12.8)') 'TOTAL ENERGY:       ', E_ele + Enn
